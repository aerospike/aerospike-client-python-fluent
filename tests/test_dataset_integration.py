...
@pytest.mark.asyncio
async def test_key_value_with_dataset(aerospike_host):
...
@pytest.mark.asyncio
async def test_key_value_with_key_object(aerospike_host):
...
@pytest.mark.asyncio
async def test_query_with_dataset(aerospike_host):
...
@pytest.mark.asyncio
async def test_query_with_single_key(aerospike_host):
...
@pytest.mark.asyncio
async def test_query_with_multiple_keys(aerospike_host):
