...
class TestInLiteral:
    ...
    def test_string_literal_in_list_literal(self):
        ...
        assert parse_dsl('"gold" in ["gold", "silver"]') == expected
    ...
    def test_int_literal_in_list_literal(self):
        ...
        assert parse_dsl("100 in [100, 200, 300]") == expected
    ...
    def test_float_literal_in_list_literal(self):
        ...
        assert parse_dsl("1.5 in [1.0, 2.0, 3.0]") == expected
    ...
    def test_bool_literal_in_list_literal(self):
        ...
        assert parse_dsl("true in [true, false]") == expected
    ...
    def test_list_literal_in_list_of_lists(self):
        ...
        assert parse_dsl("[1,2,3] in [[2,3,4], [3,4,5], [1,2,3], [1,2]]") == expected
    ...
    def test_list_bin_in_list_of_lists(self):
        ...
        assert parse_dsl("$.listBin in [[2,3,4], [3,4,5], [1,2,3], [1,2]]") == expected
    ...
    def test_map_literal_in_list_of_maps(self):
        ...
        assert parse_dsl('{1: "a"} in [{1: "a"}, {2: "b"}]') == expected
    ...
    def test_map_bin_in_list_of_maps(self):
        ...
        assert parse_dsl('$.mapBin in [{1: "a"}, {2: "b"}]') == expected
    ...
    def test_bin_in_string_list_literal(self):
        ...
        assert parse_dsl('$.name in ["Bob", "Mary"]') == expected
    ...
    def test_bin_in_int_list_literal(self):
        ...
        assert parse_dsl("$.age in [18, 21, 65]") == expected
    ...
    def test_bin_in_float_list_literal(self):
        ...
        assert parse_dsl("$.score in [1.0, 2.5]") == expected
    ...
    def test_bin_in_bool_list_literal(self):
        ...
        assert parse_dsl("$.isActive in [true, false]") == expected
    ...
    def test_explicit_int_bin_in_list_designator(self):
        ...
        assert parse_dsl("$.name.get(type: INT) in $.binName.[]") == expected
    ...
    def test_in_with_single_element_list(self):
        ...
        assert parse_dsl('$.name in ["Bob"]') == expected
    ...
    def test_in_with_negative_ints(self):
        ...
        assert parse_dsl("$.val in [-1, 0, 1]") == expected
    ...
    def test_in_with_negative_floats(self):
        ...
        assert parse_dsl("$.val in [-1.5, 0.0, 1.5]") == expected
    ...
    def test_in_with_hex_binary_literals(self):
        ...
        assert parse_dsl("$.val in [0xFF, 0b101, 42]") == expected
...
class TestInBin:
    ...
    def test_string_literal_in_bin(self):
        ...
        assert parse_dsl('"gold" in $.allowedStatuses') == expected
    ...
    def test_int_literal_in_bin(self):
        ...
        assert parse_dsl("100 in $.allowedValues") == expected
    ...
    def test_float_literal_in_bin(self):
        ...
        assert parse_dsl("1.5 in $.scores") == expected
    ...
    def test_bool_literal_in_bin(self):
        ...
        assert parse_dsl("true in $.flags") == expected
    ...
    def test_list_literal_in_bin(self):
        ...
        assert parse_dsl("[1, 2, 3] in $.listOfLists") == expected
    ...
    def test_map_literal_in_bin(self):
        ...
        assert parse_dsl('{1: "a"} in $.mapItems') == expected
...
class TestInPlaceholder:
    ...
    def test_int_placeholder_as_left_operand(self):
        ...
        assert parse_dsl("?0 in [100, 200, 300]", 100) == expected
    ...
    def test_float_placeholder_as_left_operand(self):
        ...
        assert parse_dsl("?0 in [1.0, 2.0, 3.0]", 1.5) == expected
    ...
    def test_bool_placeholder_as_left_operand(self):
        ...
        assert parse_dsl("?0 in [true, false]", True) == expected
...
class TestInExplicitType:
    ...
    def test_explicit_int_in_int_list(self):
        ...
        assert parse_dsl("$.age.get(type: INT) in [1, 2]") == expected
    ...
    def test_explicit_string_in_string_list(self):
        ...
        assert parse_dsl('$.name.get(type: STRING) in ["a"]') == expected
    ...
    def test_explicit_int_compatible_with_float_list(self):
        ...
        assert parse_dsl("$.val.get(type: INT) in [1.5, 2.5]") == expected
    ...
    def test_explicit_float_compatible_with_int_list(self):
        ...
        assert parse_dsl("$.val.get(type: FLOAT) in [1, 2]") == expected
    ...
    def test_explicit_float_in_float_list(self):
        ...
        assert parse_dsl("$.val.get(type: FLOAT) in [1.5, 2.5]") == expected
    ...
    def test_explicit_bool_in_bool_list(self):
        ...
        assert parse_dsl("$.flag.get(type: BOOL) in [true, false]") == expected
    ...
    def test_explicit_string_bin_in_bin(self):
        ...
        assert parse_dsl("$.name.get(type: STRING) in $.list") == expected
    ...
    def test_explicit_int_bin_in_bin(self):
        ...
        assert parse_dsl("$.val.get(type: INT) in $.list") == expected
    ...
    def test_explicit_float_bin_in_bin(self):
        ...
        assert parse_dsl("$.val.get(type: FLOAT) in $.list") == expected
    ...
    def test_explicit_bool_bin_in_bin(self):
        ...
        assert parse_dsl("$.flag.get(type: BOOL) in $.list") == expected
    ...
    def test_explicit_list_bin_in_bin(self):
        ...
        assert parse_dsl("$.items.get(type: LIST) in $.list") == expected
    ...
    def test_explicit_map_bin_in_bin(self):
        ...
        assert parse_dsl("$.item.get(type: MAP) in $.list") == expected
    ...
    def test_explicit_map_bin_in_path(self):
        ...
        assert parse_dsl("$.item.get(type: MAP) in $.items.tags") == expected
    ...
    def test_cast_int_bin_in_bin(self):
        ...
        assert parse_dsl("$.val.asInt() in $.list") == expected
    ...
    def test_cast_float_bin_in_path(self):
        ...
        assert parse_dsl("$.val.asFloat() in $.items.tags") == expected
    ...
    def test_pos_placeholder_in_bin(self):
        ...
        assert parse_dsl("?0 in $.bin", 42) == expected
    ...
    def test_pos_variable_in_bin(self):
        ...
        assert parse_dsl("let (x = 1) then (${x} in $.list)") == expected
    ...
    def test_map_designator_bin_in_bin(self):
        ...
        assert parse_dsl("$.item.{} in $.list") == expected
    ...
    def test_count_path_in_list_bin(self):
        ...
        assert parse_dsl("$.items.[0].count() in $.list") == expected
    ...
    def test_count_list_bin(self):
        ...
        assert parse_dsl("$.items.[].count() in $.list") == expected
    ...
    def test_neg_explicit_int_type_on_right_bin(self):
        with pytest.raises(DslParseException, match="IN operation requires a List"):
            parse_dsl("$.name in $.tags.get(type: INT)")

    def test_neg_explicit_string_type_on_right_bin(self):
        with pytest.raises(DslParseException, match="IN operation requires a List"):
            parse_dsl("$.name in $.tags.get(type: STRING)")

    def test_neg_nested_path_explicit_string_on_right(self):
        with pytest.raises(DslParseException, match="IN operation requires a List"):
            parse_dsl("$.name in $.tags.nested.get(type: STRING)")
...
class TestInComposite:
    ...
    def test_in_with_or(self):
        ...
        assert parse_dsl('$.status in ["active"] or $.priority > 5') == expected
    ...
    def test_in_with_parentheses(self):
        ...
        assert parse_dsl('($.name in ["Bob"]) and $.age > 18') == expected
    ...
    def test_not_wrapping_in(self):
        ...
        assert parse_dsl('not($.name in ["Bob", "Mary"])') == expected
    ...
    def test_arithmetic_expr_as_left_in(self):
        ...
        assert parse_dsl("$.a + 5 in [10, 20, 30]") == expected
...
class TestInNegative:
    ...
    def test_neg_bin_in_bin_ambiguous(self):
        with pytest.raises(DslParseException, match="cannot infer the type"):
            parse_dsl("$.itemType in $.allowedItems")

    def test_neg_bin_in_path_ambiguous(self):
        with pytest.raises(DslParseException, match="cannot infer the type"):
            parse_dsl("$.name in $.rooms.room1.name")
    ...
    def test_neg_path_in_bin_ambiguous(self):
        with pytest.raises(DslParseException, match="cannot infer the type"):
            parse_dsl("$.rooms.room1.name in $.list")
    ...
    def test_neg_bin_in_variable_ambiguous(self):
        with pytest.raises(DslParseException, match="cannot infer the type"):
            parse_dsl('let (x = ["a"]) then ($.name in ${x})')
    ...
    def test_neg_placeholder_missing_value(self):
        with pytest.raises(DslParseException, match="no placeholder values provided"):
            parse_dsl("$.name.get(type: STRING) in ?0")
    ...
    def test_neg_placeholder_index_out_of_bounds(self):
        with pytest.raises(DslParseException, match="Missing value for placeholder"):
            parse_dsl("$.name.get(type: STRING) in ?1", 42)
...
class TestInGrammarConflicts:
    ...
    def test_bin_named_in_equality(self):
        ...
        assert parse_dsl("$.in == 5") == expected
    ...
    def test_bin_named_in_in_list(self):
        ...
        assert parse_dsl("$.in in [1, 2]") == expected
    ...
    def test_map_key_named_in_nested(self):
        ...
        assert parse_dsl("$.map.a.in > 5") == expected
    ...
    def test_simple_map_key_named_in(self):
        ...
        assert parse_dsl("$.list.in == 5") == expected
    ...
    def test_map_key_range_start_in(self):
        ...
        assert parse_dsl("$.mapBin.{in-z}") == expected
    ...
    def test_map_key_range_end_in(self):
        ...
        assert parse_dsl("$.mapBin.{a-in}") == expected
    ...
    def test_map_key_range_open_end_in(self):
        ...
        assert parse_dsl("$.mapBin.{in-}") == expected
    ...
    def test_relative_index_with_key_in(self):
        ...
        assert parse_dsl("$.mapBin.{0:1~in}") == expected
