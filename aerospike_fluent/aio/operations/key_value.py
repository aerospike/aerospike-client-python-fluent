...
class BinBuilder:
    ...
    async def execute(self) -> None:
        ...
        2. Add all increments via .increment_by()
        3. Remove other bins if .and_remove_other_bins() was called (by setting them to None)
        """
        ...
        if operations:
            await self._operation.operate(operations)
        elif self._bins:
