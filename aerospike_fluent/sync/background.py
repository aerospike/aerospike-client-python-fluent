...
class SyncBackgroundWriteBinBuilder:
    ...
    See Also:
        :class:`~aerospike_fluent.aio.background.BackgroundWriteBinBuilder`
    """
...
class SyncBackgroundOperationBuilder:
    ...
    See Also:
        :class:`~aerospike_fluent.aio.background.BackgroundOperationBuilder`
    """
    ...
    def where(
        ...
        """Restrict the scan with a DSL or filter predicate."""
    ...
    def execute(self) -> ExecuteTask:
        ...
        See Also:
            :meth:`~aerospike_fluent.aio.background.BackgroundOperationBuilder.execute`
        """
        inner = self._inner
...
class SyncBackgroundUdfFunctionBuilder:
    ...
    See Also:
        :class:`~aerospike_fluent.aio.background.BackgroundUdfFunctionBuilder`
    """
...
class SyncBackgroundUdfBuilder:
    ...
    See Also:
        :class:`~aerospike_fluent.aio.background.BackgroundUdfBuilder`
    """
    ...
    def execute(self) -> ExecuteTask:
        ...
        See Also:
            :meth:`~aerospike_fluent.aio.background.BackgroundUdfBuilder.execute`
        """
        inner = self._inner
...
class SyncBackgroundTaskSession:
    ...
    Obtained from :meth:`~aerospike_fluent.sync.session.SyncSession.background_task`.
    Each method returns a sync builder that mirrors
    :class:`~aerospike_fluent.aio.background.BackgroundTaskSession`.
